...
from spots.models import SecondLifeCenter
import requests
import logging
...
class Command(BaseCommand):
    help = 'Imports second life center data from an external API'

    def handle(self, *args, **options):
        self.fetch_and_import_records()

    def fetch_and_import_records(self):
        base_url = "https://opendata.paris.fr/api/explore/v2.1/catalog/datasets/dechets-menagers-points-dapport-volontaire-recycleries-et-ressourceries/records"
        offset = 0
        limit = 100
        ...
        while True:
            ...
            for record in results:
                ...
                try:
                    ...
                    second_life, created = SecondLifeCenter.objects.update_or_create(
                        trash_id=unique_id,
                        defaults={
